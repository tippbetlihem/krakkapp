    ...
    return (
      <AuthCard>
        <div className="text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-neutral-900">Tolvupostur sendur</h2>
          <p className="text-sm text-neutral-500">
            Ef reikningur er til med thessu netfangi faerdu tolvupost med
            leidbeiningum til ad endurstilla lykilordid thitt.
          </p>
          <Link
            href="/login"
            className="inline-block text-sm text-evergreen-500 font-bold hover:text-gold-500 transition-colors"
          >
            Til baka i innskraningu
          </Link>
        </div>
      </AuthCard>
    );
  ...
  return (
    <AuthCard>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <h2 className="text-2xl font-extrabold text-neutral-900">Gleymt lykilord</h2>
          <p className="text-sm text-neutral-500 mt-1">
            Slaou inn netfangid thitt og vid sendum ther tengil til ad endurstilla lykilordid.
          </p>
        </div>
